...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="index.html"><span><img class="mt-5" width="100px" height="100px" src="https://upload.wikimedia.org/wikipedia/commons/6/63/Lambang_Kementerian_Lingkungan_Hidup_dan_Kehutanan.png" alt=""></span></a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="{{ route('frontend.peta.index') }}" target="_blank">Peta</a>
                    </li>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                    <div data-aos="zoom-out">
                        ...
                        <h2>Java GIS menawarkan solusi pemetaan dan alat analisis spasial tingkat lanjut, memungkinkan
                            Anda memanfaatkan potensi penuh data geospasial untuk pengambilan keputusan yang tepat dan
                            wawasan yang tak tertandingi.</h2>
                        <div class="text-center text-lg-start">
                            <a href="{{ route('frontend.peta.index') }}" class="btn-get-started scrollto">Get
                                Started</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
                    <img src="{{ asset('bootslander') }}/assets/img/hero-1.png" class="img-fluid animated"
                        alt="">
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5"
                        ...
                        <p>Explore the myriad capabilities of Java GIS that revolutionize how you interact with
                            geographic data. From dynamic mapping to sophisticated spatial analysis, our platform
                            empowers users with unparalleled versatility and precision. Discover the key features and
                            benefits that make Java GIS the ultimate solution for unlocking the potential of geospatial
                            information</p>
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-md-4" data-aos="fade-right">
                        <img src="{{ asset('bootslander') }}/assets/img/details-1.png" class="img-fluid"
                            alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="{{ asset('bootslander') }}/assets/img/details-2.png" class="img-fluid"
                            alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4" data-aos="fade-right">
                        <img src="{{ asset('bootslander') }}/assets/img/details-3.png" class="img-fluid"
                            alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="{{ asset('bootslander') }}/assets/img/details-4.png" class="img-fluid"
                            alt="">
                    </div>
                    <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
                ...
                <div class="row g-0" data-aos="fade-left">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
                            <a href="{{ asset('bootslander') }}/assets/img/gallery/gallery-1.jpg"
                                class="gallery-lightbox">
                                <img src="{{ asset('bootslander') }}/assets/img/gallery/gallery-1.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="150">
                            <a href="{{ asset('bootslander') }}/assets/img/gallery/gallery-2.jpg"
                                class="gallery-lightbox">
                                <img src="{{ asset('bootslander') }}/assets/img/gallery/gallery-2.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200">
                            <a href="{{ asset('bootslander') }}/assets/img/gallery/gallery-3.jpg"
                                class="gallery-lightbox">
                                <img src="{{ asset('bootslander') }}/assets/img/gallery/gallery-3.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="250">
                            <a href="{{ asset('bootslander') }}/assets/img/gallery/gallery-4.jpg"
                                class="gallery-lightbox">
                                <img src="{{ asset('bootslander') }}/assets/img/gallery/gallery-4.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
                            <a href="{{ asset('bootslander') }}/assets/img/gallery/gallery-5.jpg"
                                class="gallery-lightbox">
                                <img src="{{ asset('bootslander') }}/assets/img/gallery/gallery-5.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="350">
                            <a href="{{ asset('bootslander') }}/assets/img/gallery/gallery-6.jpg"
                                class="gallery-lightbox">
                                <img src="{{ asset('bootslander') }}/assets/img/gallery/gallery-6.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
                            <a href="{{ asset('bootslander') }}/assets/img/gallery/gallery-7.jpg"
                                class="gallery-lightbox">
                                <img src="{{ asset('bootslander') }}/assets/img/gallery/gallery-7.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item" data-aos="zoom-in" data-aos-delay="450">
                            <a href="{{ asset('bootslander') }}/assets/img/gallery/gallery-8.jpg"
                                class="gallery-lightbox">
                                <img src="{{ asset('bootslander') }}/assets/img/gallery/gallery-8.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('bootslander') }}/assets/img/testimonials/testimonials-1.jpg"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('bootslander') }}/assets/img/testimonials/testimonials-2.jpg"
                                    class="testimonial-img" alt="">
                                <h3>Sara Wilsson</h3>
                                <h4>Designer</h4>
                                <p>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('bootslander') }}/assets/img/testimonials/testimonials-3.jpg"
                                    class="testimonial-img" alt="">
                                <h3>Jena Karlis</h3>
                                <h4>Store Owner</h4>
                                <p>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('bootslander') }}/assets/img/testimonials/testimonials-4.jpg"
                                    class="testimonial-img" alt="">
                                <h3>Matt Brandon</h3>
                                <h4>Freelancer</h4>
                                <p>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('bootslander') }}/assets/img/testimonials/testimonials-5.jpg"
                                    class="testimonial-img" alt="">
                                <h3>John Larson</h3>
                                <h4>Entrepreneur</h4>
                                <p>
                ...
                <div class="row" data-aos="fade-left">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="member" data-aos="zoom-in" data-aos-delay="100">
                            <div class="pic"><img src="{{ asset('bootslander') }}/assets/img/team/team-1.jpg"
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="pic"><img src="{{ asset('bootslander') }}/assets/img/team/team-2.jpg"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Sarah Jhonson</h4>
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                        <div class="member" data-aos="zoom-in" data-aos-delay="300">
                            <div class="pic"><img src="{{ asset('bootslander') }}/assets/img/team/team-3.jpg"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                        <div class="member" data-aos="zoom-in" data-aos-delay="400">
                            <div class="pic"><img src="{{ asset('bootslander') }}/assets/img/team/team-4.jpg"
                                    class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Amanda Jepson</h4>
