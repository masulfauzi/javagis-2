    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form form-horizontal" action="{{ route('penggunaanlahan.update', $penggunaanlahan->id) }}" method="POST">
                    <div class="form-body">
                        @csrf @method('patch')
                        ...
                        <div class="offset-md-3 ps-2">
                            ...
                            <a href="{{ route('penggunaanlahan.index') }}" class="btn btn-secondary">Batal</a>
                        </div>
                  </div>
                </form>
            </div>
