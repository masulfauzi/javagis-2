    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <form action="{{ route('batasadministrasi.index') }}" method="get">
                    ...
                    <div class="col-3">  
						{!! button('batasadministrasi.create', $title) !!}  
                    </div>
                </div>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										...
										{!! button('batasadministrasi.edit', $title, $item->id) !!}
                                        {!! button('batasadministrasi.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
